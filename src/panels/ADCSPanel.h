...
// then Orbit (background ephemeris context), and finally the two tabs
// that affect the test harness rather than the spacecraft itself --
...
// OrbitPanel.h/SimulationPanel.h/VisualizationPanel.h for each tab's own
// content.
