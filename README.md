...
A closed-loop Satellite ADCS (attitude determination and control system) / flight-software simulation: a single high-fidelity satellite, its sensors, its actuators, and the flight software driving them, all running against a real 6-DOF rigid-body physics engine.
